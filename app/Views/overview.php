...
<body>
    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col">
                <div class="card" style="width: 18rem;">
                    <img src="/img/makanan.jpg" class="card-img-top" alt="...">
                    <div class="card-body">
                        <p class="card-text">Makanan kekinian Vegan yang Bikin Nagih</p>
                    </div>
                </div>
            </div>
            <div class="col">
                <div class="card" style="width: 18rem;">
                    ...
                    <div class="card-body">
                        <p class="card-text">Menu terenak yang saya recomendasikan pada LN Fortunate Coffee yaitu Vegan Pizza</p>
                    </div>
                </div>
            </div>
        </div>
